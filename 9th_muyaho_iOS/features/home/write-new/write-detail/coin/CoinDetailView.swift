...
class CoinDetailView: BaseView {
    ...
    override func setup() {
        ...
        self.containerView.addSubviews(
            ...
            totalPriceLabel, avgPriceLabel, avgPriceField, purchasedMoneyLabel,
            purchasedMoneyField, amountLabel, amountValueLabel
        )
    ...
    override func bindConstraints() {
        ...
        self.containerView.snp.makeConstraints { make in
            ...
            make.bottom.equalTo(self.amountValueLabel)
        }
        ...
        self.amountLabel.snp.makeConstraints { make in
            ...
            make.top.equalTo(self.purchasedMoneyLabel.snp.bottom).offset(46)
        }
...
extension Reactive where Base: CoinDetailView {
